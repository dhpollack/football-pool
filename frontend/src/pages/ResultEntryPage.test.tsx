...
describe('ResultEntryPage', () => {
  ...
  it('submits the results', async () => {
    ...
    const favoriteScoreInput = allSpinbuttons.find(input => input.getAttribute('name') === 'favorite_score_1');
    const underdogScoreInput = allSpinbuttons.find(input => input.getAttribute('name') === 'underdog_score_1');
