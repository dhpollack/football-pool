...
import { getGetPicksResponseMock } from "../../services/api/default/default.msw";
...
describe("WeeklyPicksPage", () => {
  ...
  it("renders loading state", () => {
    ...
    expect(screen.getByTestId("load-picks-button")).toHaveTextContent("Loading...");
    // Check for loading text in our mock AdminDataTable
    expect(screen.getByTestId("admin-data-table")).toHaveTextContent("Loading...");
  });
  ...
  it("renders picks data when loaded", () => {
    ...
    expect(screen.getByTestId("pick-user")).toHaveTextContent("user1@example.com");
